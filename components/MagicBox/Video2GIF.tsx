...
import VideoOutlined from '../../icons/VideoOutlined';
  ...
  return (
    <>
      <Tooltip title="视频转gif">
        <VideoOutlined style={{ fontSize: 36 }} onClick={onShow} />
      </Tooltip>
      <Modal
        visible={visible}
        title="视频转gif"
      ...
      >
        <Row style={{ rowGap: 0 }}>
          <Col span={19}>
            <Input
              value={videoState.fileName}
              placeholder="点击这里上传视频"
              readOnly
          ...
          <Col span={5}>
            <Button type="primary" onClick={onConvertClick} loading={loading}>
              开始转换
            </Button>
          </Col>
        </Row>
        ...
        {videoState.progress !== '' && (
          <Row style={{ rowGap: 0 }}>
            <Col span={24}>
              <p style={{ margin: '15px 0', color: '#f7cf02' }}>
                {videoState.progress}
              </p>
            </Col>
          </Row>
        ...
        <Row style={{ rowGap: 0 }}>
          <Col span={24}>
            ...
            <p style={{ margin: '8px 0', color: '#2b95e2' }}>
              全部转换均在浏览器内进行，不会消耗设备流量
            </p>
            <p style={{ marginTop: 8, marginBottom: 0, color: '#2b95e2' }}>
              如果转换时间过长请使用其他浏览器尝试，推荐使用Chrome
            </p>
          </Col>
        </Row>
      </Modal>
